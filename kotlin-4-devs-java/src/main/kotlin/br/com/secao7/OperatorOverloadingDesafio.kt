...
/*
    Given two Data Classes with two attributes make sum and subtraction, return true if the return is equals to expected or false if it is not.
    Use Operator Overload to do that.
