...
class MathController {
    ...
    fun sum(@PathVariable(value = "numberOne") numberOne: String?, @PathVariable(value = "numberTwo") numberTwo: String?): Double {
        ...
        if(!NumberConverter.isNumeric(numberOne) || !NumberConverter.isNumeric(numberTwo)) throw ResourceNotFoundException("Please set a numeric value")
    ...
    fun squareRoot(@PathVariable(value = "number") number: String?): Double {
        ...
        if(!NumberConverter.isNumeric(number)) throw ResourceNotFoundException("Please set a numeric value")
